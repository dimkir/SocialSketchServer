...
@java -cp build/libs/SocialSketchServer.jar;build/output/libs/twitter4j-core-3.0.5.jar;build/output/libs/twitter4j-stream-3.0.5.jar;build/output/libs/mysql-connector-java-5.1.26.jar;build/output/libs/log4j-1.2.17.jar  org.socialsketch.server.Application %1
